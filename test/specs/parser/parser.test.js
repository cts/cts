...
test("Raw Parser", function() {
  ...
  var spec = CTS.Parser.CTS2.parse(cts);
  ...
  spec = CTS.Parser.CTS2.parse(cts);
  equal(typeof spec.headers, 'object', "Has headers");
  ...
  equal(spec.relations[0][0].selectorString, "a", "ss1");
  equal(spec.relations[0][2].selectorString, "b", "ss2");
  equal(spec.relations[0][1].name, "is", "name");
  ...
  spec = CTS.Parser.CTS2.parse(cts);
  equal(spec.relations.length, 1, "Has one relation (sp)");
  equal(spec.relations[0][0].treeName, "foo", "tree1");
  equal(spec.relations[0][0].selectorString, "a", "ss1");
  equal(spec.relations[0][2].selectorString, "b", "ss2");
  equal(spec.relations[0][2].treeName, "bar", "tree2");
  equal(spec.relations[0][1].name, "is", "name");
