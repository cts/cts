...
}, {"./forrest.js":17,"./node.js":18,"./selection.js":19,"./tree.js":20,"./relation.js":21,"./factory.js":22}],
...
}, {"cts/parser":23,"cts/util":2,"./nonexistent-node":24,"./relation":21}],
...
}, {"cts/util":2,"./json-parser":25,"./cts-parser":26,"./spec/dependency-spec":27,"./spec/forrest-spec":28,"./spec/selection-spec":29,"./spec/tree-spec":30,"./spec/relation-spec":31}],
...
}, {"cts/util":2,"./spec/relation-spec":31,"./spec/dependency-spec":27,"./spec/selection-spec":29,"./spec/tree-spec":30,"./spec/forrest-spec":28}],
...
}, {"./nonexistent-node":24,"cts/util":2}],
...
}, {"cts/model":13,"cts/util":2,"cts/relations":14}],
...
}, {"cts/util":2,"./is.js":33,"./are.js":34,"./graft.js":35,"./ifexist.js":36,"./ifnexist.js":37}],
...
}, {"./dom-node.js":38,"./dom-node-input.js":39,"./dom-tree.js":40,"./dom-factory.js":41,"./parser.js":42}],
...
}, {"./dom-node-base":43,"./dom-node-input":39,"cts/util":2,"cts/model":13}],
...
}, {"./dom-node-base":43,"cts/util":2,"cts/model":13}],
...
}, {"./dom-tree":40,"./dom-node":38,"./dom-node-input":39,"cts/util":2}],
...
}, {"cts/util":2,"./gsheet-tree":45,"./gspreadsheet-node":46,"./gsheet-util":47}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47,"./gworksheet-node":48}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47,"./glistfeed-node":49,"./gcellfeed-node":50}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47,"./glistfeeditem-node":51}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47,"./glistfeedproperty-node":52}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47,"./gcolumn-node":53}],
...
}, {"cts/util":2,"cts/model":13,"./gsheet-util":47,"./gcolumncell-node":54}],
...
}, {"cts/util":2,"./factory":11,"cts/model":13,"cts/html-adapter":15,"cloudstitch/gsheet-adapter":55}],
55: [function(require, module, exports) {
/*
 *
 */

exports.TREE_TYPES = ["gsheet", "gworksheet"];
exports.Parser = require('./parser');
exports.Factory    = require('./gsheet-factory.js');

}, {"./parser":56,"./gsheet-factory.js":57}],
...
var SpreadsheetTree = require('./spreadsheet-tree');

var Factory = {
  Tree: function(treespec, forrest) {
    var tree = new SpreadsheetTree(forrest, treespec);
    var promise = Util.Promise.defer();
    ...
    if (GSheetUtil.specRequiresLogin(treespec)) {
      ...
      Util.Log.Info("No login necessary for Spreadsheet Tree");
      buildOutTree();
    }
...
}, {"cts/util":2,"./gsheet-util":58,"./parser":56,"./spreadsheet-tree":59}],
...
var GSheetUtil = {
  ...
  // ret label -> col
  schemaForWorksheet: function(ws) {
    // Takes the first row.
    var headerRow = 1;
    var schema = {};
    if (typeof ws.rows[headerRow] != 'undefined') {
      var row = ws.rows[headerRow];
      for (var colId in row.cols) {
        var cell = row.cols[colId];
        var label = cell.o;
        schema[label] = colId;
      }
    }
  ...
  rowlistForWorksheet: function(ws) {
    var rowIds = Util._.keys(ws.rows);
    var headerRow = 1;
    var rows = [];
    rowIds.sort();
...
module.exports = GSheetUtil;
}, {"cts/util":2,"cts/parser":23,"./parser":56}],
59: [function(require, module, exports) {
var Util = require('cts/util');
var Model = require('cts/model');
var RemoteAdapter = require('cloudstitch/remote-adapter');
var SpreadsheetNode = require('./spreadsheet-node');

var SpreadsheetTree = function(forrest, spec) {
  this.forrest = forrest;
  this.spec = spec;
  this.root = null;
  this.insertionListener = null;
...
Util._.extend(SpreadsheetTree.prototype, Model.Tree.Base, RemoteAdapter.Tree.Base, {
  initializeWithRemoteRoot: function() {
    ...
    this._loadRemotePromise.then(
      function(ssObj) {
        self.value = ssObj;
        self.root = new SpreadsheetNode(self);
...
module.exports = SpreadsheetTree;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./spreadsheet-node":61}],
60: [function(require, module, exports) {
exports.Tree    = require('./remote-tree.js');
exports.Node    = require('./remote-node.js');
exports.Utils   = require('./remote-utils.js');

}, {"./remote-tree.js":62,"./remote-node.js":63,"./remote-utils.js":64}],
...
var SpreadsheetNode = function(tree, spec) {
...
Util._.extend(SpreadsheetNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  ...
  _subclass_realizeChildren: function() {
    ...
    // Assumption: We already have the sheet object in the tree.
    if (this.tree.value && this.tree.value.ws) {
      for (var wsName in this.tree.value.ws) {
        var ws = this.tree.value.ws[wsName];
        var child = new WorksheetNode(wsName, ws, self.tree);
        child.parentNode = self;
        self.children.push(child);
      }
      deferred.resolve();
    } else {
      Util.Log.Error("Spreadsheet representation received from server was not correct", this.tree.value);
      deferred.reject("Spreadsheet representation received from server was not correct");
    }
    return deferred;
  }
});

module.exports = SpreadsheetNode;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./worksheet-node":65,"./gsheet-util":58}],
65: [function(require, module, exports) {
var Util = require('cts/util');
var Model = require('cts/model');
var RemoteAdapter = require('cloudstitch/remote-adapter');
var GSheetUtil = require('./gsheet-util');
var ListFeedNode = require('./listfeed-node');
var CellFeedNode = require('./cellfeed-node');

var WorksheetNode = function(name, value, tree, spec) {
  this.initializeNodeBase(tree, {});
  this.spec = spec || {};
  this.kind = "Worksheet";
  this.value = value;
...
Util._.extend(WorksheetNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  ...
  find: function(spec, ret) {
    ...
    if ((spec.sheetSpec.projection == "Rows") || (spec.sheetSpec.projection == "Cols")) {
      for (var i = 0; i < this.children.length; i++) {
        if (this.children[i].kind == "ListFeed") {
          this.children[i].find(spec, ret);
        }
      }
    } else if (spec.sheetSpec.projection == "Cells") {
      for (var i = 0; i < this.children.length; i++) {
        if (this.children[i].kind == "CellFeed") {
          this.children[i].find(spec, ret);
        }
      }
    } else {
    ...
    console.log("FOUND", spec, ret);
    return ret;
  },

  isDescendantOf: function(other) {
    return (other == this.parentNode);
  },
  ...
  _subclass_realizeChildren: function() {
    ...
    // Assumption: We already have the sheet object in the tree.
    if (this.value) {
      var lf = new ListFeedNode(this.value, this.tree);
      lf.parentNode = this;
      var cf = new CellFeedNode(this.value, this.tree);
      cf.parentNode = this;
      this.children = [lf, cf];
      deferred.resolve();
    } else {
      Util.Log.Error("Worksheet representation received from server was not correct");
      deferred.reject("Worksheet representation received from server was not correct");
    }
    return deferred;
  }
});

module.exports = WorksheetNode;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58,"./listfeed-node":66,"./cellfeed-node":67}],
66: [function(require, module, exports) {
var Util = require('cts/util');
var Model = require('cts/model');
var RemoteAdapter = require('cloudstitch/remote-adapter');
var GSheetUtil = require('./gsheet-util');
var ListItemNode = require('./listitem-node');

var ListFeedNode = function(value, tree, opts) {
  opts = opts || {};
  this.initializeNodeBase(tree, opts);
  this.value = value;
  this.schema = GSheetUtil.schemaForWorksheet(this.value);
  this.rowlist = GSheetUtil.rowlistForWorksheet(this.value);
  this.ctsId = Util._.uniqueId().toString();
  this.kind = 'ListFeed';
  this.on('received-is', function() {
    this.value.trigger('cts-received-is');
...
Util._.extend(ListFeedNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  debugName: function() {
    return this.kind;
  },

  // Find always returns empty on a leaf.
  find: function(spec, ret) {
    spec = GSheetUtil.fixSpec(spec);
    if (typeof ret == 'undefined') {
      ret = [];
  ...
  _subclass_realizeChildren: function() {  
    ...
    if (this.value && this.rowlist) {
      for (var i = 0; i < this.rowlist.length; i++) {
        var rowId = this.rowlist[i];
        var row = this.value.rows[rowId];
        var li = new ListItemNode(row, rowId, this.schema, this.tree, this.opts);
        li.parentNode = this;
   ...
   _subclass_beginClone: function(node) {
    Util.Log.Error("A Listfeed should not be cloned.");
    return null;
   },
...
module.exports = ListFeedNode;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58,"./listitem-node":68}],
68: [function(require, module, exports) {
var Util = require('cts/util');
var Model = require('cts/model');
var RemoteAdapter = require('cloudstitch/remote-adapter');
var GSheetUtil = require('./gsheet-util');
var ItemPropertyNode = require('./itemproperty-node');

var ListItemNode = function(value, rowId, schema, tree, opts) {
  opts = opts || {};
  this.initializeNodeBase(tree, opts);
  this.value = value;
  this.rowId = rowId;
  this.schema = schema; // label -> Column
  this.ctsId = Util._.uniqueId().toString();
  this.kind = 'ListItem';
  this.on('received-is', function() {
    this.value.trigger('cts-received-is');
...
Util._.extend(ListItemNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  debugName: function() {
    return this.kind;
  },
  ...
  _subclass_realizeChildren: function() {    
    ...
    if (this.value) {
      for (var property in this.schema) {
        var colId = this.schema[property];
        var val = this.value.cols[colId];
        var child = new ItemPropertyNode(property, val, this.tree, this.opts);
        child.parentNode = this;
        this.children.push(child);
      }
      deferred.resolve();
    ...
    */
   _onChildInserted: function(child) {
     Util.Log.Error("onChildInserted called (impossibly) on ListItemNode Node");
   },
   ...
   _subclass_beginClone: function() {
     var d = Util.Promise.defer();
     var value = Util.Helper.deepClone(this.value);
     var clone = new ListItemNode(value, this.tree, this.opts);
     clone.realizeChildren().then(
       function() {
         d.resolve(clone);
       },
  ...
  setValue: function(value, opts) {
    Util.Log.Error("You can't set the value of a ListItemNode node");
  }
...
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58,"./itemproperty-node":69}],
...
var ItemPropertyNode = function(key, value, tree, opts) {
  opts = opts || {};
  this.initializeNodeBase(tree, opts);
  this.key = key;
  this.value = value;
  this.ctsId = Util._.uniqueId().toString();
  this.kind = 'ItemProperty';
...
Util._.extend(ItemPropertyNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  debugName: function() {
    return this.kind;
  },
  ...
  _subclass_realizeChildren: function() {    
   ...
   _remote_getNodeId: function() {
    var wsspec = this.parentNode.parentNode.value;
    var colletter = this.parentNode.parentNode.schema[this.key];
    var colnum = wsspec.colLetterToRowNum[colletter];
    var rownum = this.parentNode.rowId;
    var wskey = wsspec.key
    return {kind: 'cell-node', wskey: wskey, rownum: rownum, colnum: colnum};
   },
  ...
  setValue: function(value, opts) {
    this.value.o = value;
    this._remote_setValue(value);
  }

});

module.exports = ItemPropertyNode;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58}],
67: [function(require, module, exports) {
var Util = require('cts/util');
var Model = require('cts/model');
var RemoteAdapter = require('cloudstitch/remote-adapter');
var GSheetUtil = require('./gsheet-util');
var RowNode = require('./row-node');

var CellFeedNode = function(value, tree, opts) {
  opts = opts || {};
  this.initializeNodeBase(tree, opts);
  this.value = value;
  this.ctsId = Util._.uniqueId().toString();
...
Util._.extend(CellFeedNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  debugName: function() {
    return this.kind;
  },
  ...
  find: function(spec, ret) {
    ...
    console.log("cellfeed find", spec);
    var kids = this.getChildren();
    if (spec.sheetSpec.row && spec.sheetSpec.col) {
      var row = parseInt(spec.sheetSpec.row);
      if (! isNaN(row)) {
        for (var i = 0; i < kids.length; i++) {
          if (kids[i].row == spec.sheetSpec.row) {
            kids[i].find(spec, ret);
          }
        }
      }
  ...
  _subclass_realizeChildren: function() {  
    var deferred = Util.Promise.defer();
    this.children = [];
    for (var rowId in this.value.rows) {
      var row = this.value.rows[rowId];
      var rowNode = new RowNode(rowId, row, this.tree, this.opts);
      rowNode.parentNode = this;
      this.children.push(rowNode);
    }
    deferred.resolve();
    return deferred.promise;
  },
    ...
    */
   _onChildInserted: function(child) {
     Util.Log.Error("onChildInserted called (impossibly) on CellFeedNode Node");
   },
   ...
   _subclass_beginClone: function(node) {
    Util.Log.Error("A CellFeedNode should not be cloned.");
    return null;
   },
  ...
  setValue: function(value, opts) {
    Util.Log.Error("You can't set the value of a CellFeed node");
  },


});

module.exports = CellFeedNode;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58,"./row-node":70}],
70: [function(require, module, exports) {
var Util = require('cts/util');
var Model = require('cts/model');
var RemoteAdapter = require('cloudstitch/remote-adapter');
var GSheetUtil = require('./gsheet-util');
var CellNode = require('./cell-node');

var RowNode = function(rowNum, row, tree, opts) {
  opts = opts || {};
  this.initializeNodeBase(tree, opts);
  this.row = rowNum;
  this.value = row;
...
Util._.extend(RowNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  debugName: function() {
    return this.kind;
  },
  ...
  find: function(spec, ret) {
    spec = GSheetUtil.fixSpec(spec);
    console.log("Row find", spec);
    if (typeof ret == 'undefined') {
      ret = [];
    }
    var kids = this.getChildren();
    if (spec.sheetSpec.col) {
      console.log("row finding col", spec.sheetSpec.col);
      for (var i = 0; i < kids.length; i++) {
        console.log(spec.sheetSpec.col, "against", kids[i].col);
        if (kids[i].col == spec.sheetSpec.col) {
          ret.push(kids[i]);
        }
      }
    }
  ...
  _subclass_realizeChildren: function() {
    ...
    this.children = [];
    if (this.value.cols) {
      for (var col in this.value.cols) {
        var val = this.value.cols[col];
        var cn = new CellNode(this.row, col, val, this.tree, this.opts);
        cn.parentNode = this;
   ...
   _subclass_insertChild: function(child, afterIndex) {
     Util.Log.Error("insertChild called (impossibly) on RowNode");
   },

   /*
    */
   _onChildInserted: function(child) {
     Util.Log.Error("onChildInserted called (impossibly) on RowNode Node");
   },
  ...
  setValue: function(value, opts) {
    Util.Log.Error("You can't set the value of a RowNode node");
  }

});

module.exports = RowNode;
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58,"./cell-node":71}],
...
var CellNode = function(row, col, val, tree, opts) {
  opts = opts || {};
  this.initializeNodeBase(tree, opts);
  this.row = row;
  this.col = col;
...
Util._.extend(CellNode.prototype, Model.Node.Base, RemoteAdapter.Node.Base, Util.Events, {
  debugName: function() {
    return this.kind;
  },
  ...
  _subclass_realizeChildren: function() {
   ...
   _remote_getNodeId: function() {
    ...
    var wsspec = this.parentNode.parentNode.value;
    var colnum = wsspec.colLetterToRowNum[this.col];
    var wskey = wsspec.key
    return {kind: 'cell-node', wskey: wskey, rownum: rownum, colnum: colnum};
   },
...
}, {"cts/util":2,"cts/model":13,"cloudstitch/remote-adapter":60,"./gsheet-util":58}]}, {}, {"1":""})
