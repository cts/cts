...
### BEGIN INIT INFO
# Provides:          treesheets-server
# Required-Start:    $local_fs $remote_fs $network $syslog $nginx
# Required-Stop:     $local_fs $remote_fs $network $syslog $nginx
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: manages the CTS website service
# Description:       manages the CTS website service
### END INIT INFO
...
LOCAL_VAR_RUN=/sites/treesheets.org/run
